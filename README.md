...
- :technologist: Me gusta resolver `Problemas` usando programas.
- :student:Actualmente estoy cursando `Tecnicatura Universitaria en Programación`.
- :computer::seedling:Estoy estudiando Js 
- :nerd_face: Siempre `estudio cosas nuevas`.
